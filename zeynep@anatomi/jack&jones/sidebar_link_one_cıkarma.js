...
const a_container = document.querySelectorAll('.uk-nav.uk-nav-primary.uk-position-relative li')
a_container[0].classList.add('anatomi_li');
if (a_container[0]) {
>>>>>>> 498cbb0 (anatomi-task)
...
=======
a_container[0].insertAdjacentElement('beforeend', a_div);
>>>>>>> 498cbb0 (anatomi-task)
}
