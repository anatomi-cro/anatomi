...
const originalPrice = document.querySelectorAll('span.uk-text-bold')[1].innerText
...
const list_ul = document.querySelectorAll('.size.product-variants.variant-groups.variant-has-error-Size.variant-group-index-1')[1];
const list_li = list_ul.getElementsByTagName('li');

for (let i = 0; i < list_li.length; i++) {
  list_li[i].addEventListener('click', function() {
    anatomiBedenTablosu.style.display = 'none';
  });
}
