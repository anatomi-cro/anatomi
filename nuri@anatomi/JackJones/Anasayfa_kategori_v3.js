if (window.innerWidth < 900) {
  const anatomi_kategori_html = `
    ...
    <div class="anatomi_category_content">
          <div class="anatomi_category_titles">
            <div class="anatomi_category_woman_title">
              <img
                src="https://anatomi.s3.eu-north-1.amazonaws.com/1.webp"
                alt=""
              />
              <a href="" class="anatomi_category_title anatomi_category_woman"
                >Kadın</a
              >
            </div>
            <div class="anatomi_category_woman_title">
              <img
                src="https://anatomi.s3.eu-north-1.amazonaws.com/2.webp"
                alt=""
              />
              <a href="" class="anatomi_category_title anatomi_category_man"
                >Erkek</a
              >
            </div>
          </div>
  ...
  const anatomi_kategori_style = `
    ...
    .anatomi_category_body_man_item h4 img{
      ...
      height: 18px;
        ...
        .anatomi_category_woman_title, .anatomi_category_man_title {
          display: flex;
          flex-direction: column;
          gap: 10px;
          align-items: center;
        ...
        .anatomi_category_woman_title img , .anatomi_category_man_title img{
     width: 100px;
    height: 100px;
    border-radius: 50%;
        }
  ...
  const womanItem = document.querySelectorAll(
    ".anatomi_category_body_woman_item"
  );
  ...
  const womanList = document.querySelector(".anatomi_category_body_woman_list");
