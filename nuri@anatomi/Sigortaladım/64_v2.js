...
<div class="anatomi_blog_tabli_menu_content">
  ...
  <a href="" class="anatomi_blog_tabli_menu_titles_kasko title-active"> Kasko Sigortası </a>
    <a href="" class="anatomi_blog_tabli_menu_titles_trafik"> Trafik Sigortası </a>
  </div>

  <div class="anatomi_tabli_menu_forms">
    <div class="anatomi_blog_tabli_menu_trafik"></div>
    <div class="anatomi_blog_tabli_menu_kasko tabli_active"></div>
  </div>
</div>
</div>
`;
...
const kaskoForm2 = document.querySelector(".pre-form.right-side-casco.casco");
