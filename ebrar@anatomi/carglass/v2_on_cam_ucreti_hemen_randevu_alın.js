  ...
  const on_cam_tamir_ucreti_sticky_buton_css = () => {
    ...
    const on_cam_tamir_ucreti_sticky_buton_js = () => {
      const generateStaticBtn = () => {
            ...
            const targetElement3 = document.querySelector("#content > div > div > div > div > div.span9 > div:nth-child(43)")
    if(targetElement3) {
        targetElement3.style.display = "none";
    }
    const targetElement2 = document.querySelector("#content > div > div > div > div > div.span9 > div:nth-child(44)")
        if(targetElement2) {
