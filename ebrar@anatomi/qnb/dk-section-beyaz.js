...
@media (max-width: 768px) {
 ...
 const kutuContainer = document.querySelector("body > main > section.uk-section.uk-background-gradient-primary.uk-light.anatomi-uc-adım-section > div > div.uk-grid.uk-grid-20.uk-child-width-1-3\\@m.uk-margin-32.uk-margin-medium\\@m.uk-grid-match.notranslate")
    if (kutuContainer) {
