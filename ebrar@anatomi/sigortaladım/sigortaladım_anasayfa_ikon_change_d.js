...
const anasayfa_ikon_change_js = () => {
  ...
  if (trafikLink) {
    trafikLink.classList.add(
      "anatomi_ürün_kartları_link",
      "anatomi_ürün_kartları_link_trafik"
    );
  }
  ...
  if (kaskoLink) {
    kaskoLink.classList.add(
      "anatomi_ürün_kartları_link",
      "anatomi_ürün_kartları_link_kasko"
    );
  }
  ...
  if (saglikLink) {
    saglikLink.classList.add(
      "anatomi_ürün_kartları_link",
      "anatomi_ürün_kartları_link_saglik"
    );
  }
  ...
  if (daskLink) {
    daskLink.classList.add(
      "anatomi_ürün_kartları_link",
      "anatomi_ürün_kartları_link_dask"
    );
  }
  ...
  if (aracımaSigortaLink) {
    aracımaSigortaLink.classList.add(
      "anatomi_ürün_kartları_link",
      "anatomi_ürün_kartları_link_aracımaSigorta"
    );
  }
  ...
  if (seyahatSigortaLink) {
    seyahatSigortaLink.classList.add(
      "anatomi_ürün_kartları_link",
      "anatomi_ürün_kartları_link_seyahat"
    );
  }
  ...
  if (primHayatSigortasıLink) {
    primHayatSigortasıLink.classList.add(
      "anatomi_ürün_kartları_link",
      "anatomi_ürün_kartları_link_primHayat"
    );
  }
  ...
  if (konutLink) {
    konutLink.classList.add(
      "anatomi_ürün_kartları_link",
      "anatomi_ürün_kartları_link_konut"
    );
  }
  ...
  if (immLink) {
    immLink.classList.add(
      "anatomi_ürün_kartları_link",
      "anatomi_ürün_kartları_link_imm"
    );
  }
  ...
  if (motorsikletLink) {
    motorsikletLink.classList.add(
      "anatomi_ürün_kartları_link",
      "anatomi_ürün_kartları_link_motorsiklet"
    );
  }
