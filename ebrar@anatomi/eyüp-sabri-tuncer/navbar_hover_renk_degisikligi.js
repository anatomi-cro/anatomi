...
const navbar_hover_renk_degisikligi_css = () => {
  const style = `
    ...
    #wide-nav > div > div > div > div > div.newHeaderNav > ul > li:nth-child(1):hover{
        background-color: #264734;
        color: white;
        border-radius: 5px;
        padding: 0px 10px;
    }
    #wide-nav > div > div > div > div > div.newHeaderNav > ul > li:nth-child(1):hover a{
    color: #ffff;
        }
    ...
    .anatomi_navbar_firsat_img{
      ...
      #wide-nav > div > div > div > div > div.newHeaderNav > ul > li:nth-child(1) > a:hover .anatomi_navbar_firsat_img{
       display: block;
    }   
      </style>
    `;
