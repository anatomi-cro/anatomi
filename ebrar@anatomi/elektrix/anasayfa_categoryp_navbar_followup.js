if(window.innerWidth < 768 && (window.location.pathname === "/" || document.querySelector("#catImg")) ){
...
const a_new_html = `
<div class="icon_navbar anatomi_navBar_container">


<a class="anatomi_navBar_item" href="https://www.elektrix.com/">
<div class="a_icon">
...
<a class="anatomi_navBar_item" href="https://www.elektrix.com/cok-satanlar">
...
<a class="anatomi_navBar_item" href="https://www.elektrix.com/sepet">
...
<a class="anatomi_navBar_item" href="javascript:void(0)">
...
<a class="anatomi_navBar_item" href="https://www.elektrix.com/uye-girisi-sayfasi">
<div class="a_icon">
...
setInterval(() => {
  const element = document.querySelector(".anatomi_navBar_container");
  if (!element) {
...
setTimeout(() => {
    ...
    a_sidebar && a_sidebar_icon.addEventListener("click", function () {
    ...
    abc && abc.insertAdjacentElement("afterbegin", a_search);
    ...
    a_icon && a_icon.addEventListener("click", function () {
