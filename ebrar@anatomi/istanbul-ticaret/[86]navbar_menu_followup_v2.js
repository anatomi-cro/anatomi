const navbar_menu_followup_html = () => {
    ...
    <div class="anatomi_navbar">
      ...
      <a href="/kategoriler" class="anatomi_nav_item">
      ...
      <a href="https://www.istanbulticaret.com/indirim-urunleri" class="anatomi_nav_item anatomi_indirim">
        <img class="anatomi_indirim_icon" src="https://cro-anatomi.s3.eu-north-1.amazonaws.com/ist-tic-indirim-deneme.png" alt="Indirim">
        <span>İndirim</span>
      </a>
