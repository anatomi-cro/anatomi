...
const depo_info_js = () => {
    const addInfoSectionDesktop = () => {
        ...
        if(kargoInfoContainer && !kargoInfoContainer.classList.contains("anatomi_header_section")){
            ...
            kargoInfoContainer.textContent = "Depomuzun taşınması sebebiyle 30 Mayıs – 10 Haziran tarihleri arasında verdiğiniz siparişler, 10 Haziran’dan sonra kargoya verilecektir.!"
        }
