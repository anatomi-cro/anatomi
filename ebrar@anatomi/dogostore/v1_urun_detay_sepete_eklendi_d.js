...
const urun_detay_sepete_eklendi_js = () => {
    ...
    addToCartButton.addEventListener("click", () => {
      ...
      const interval = setInterval(() => {
        ...
        if (newProductCount > productCount) {
          ...
          urunResim.src =
            document.querySelector("#zoomImage0")?.getAttribute("src") || "";
  ...
  const changeText = () => {
    const flag = document.querySelector(
      "#lang-toggle > div.col.col-12.drop-down-title > img"
    );
    const text1 = document.querySelector(
      "body > div.anatomi-sepete-eklendi-pop-up-container > div > div.anatomi-sepete-eklendi-urun > div > div > h4"
    );
    const text2 = document.querySelector(
      ".anatomi-sepete-eklendi-button-primary"
    );
    const text3 = document.querySelector(".anatomi-sepete-eklendi-button");

    if (flag.src.includes("usa")) {
      text1.textContent = "Item Added to Cart";
      text2.textContent = "Go to Cart";
      text3.textContent = "Continue Shopping";
    } else if (flag.src.includes("france")) {
      text1.textContent = "Produit ajouté au panier";
      text2.textContent = "Aller au panier";
      text3.textContent = "Continuer vos achats";
    }
  };
  closePopUp();
  openPopUp();
