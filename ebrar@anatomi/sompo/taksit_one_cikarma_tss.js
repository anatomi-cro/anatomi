...
const taksit_one_cikarma_js = () => {
    const generateTaksitContainer = () => {
        const targetElement = document.querySelector("body > main > section.image-detail > div.image-detail__content.-campaign > div > div.get-offer > button:nth-child(9)")
        ...
        if (!taksitContainer) {
            ...
            if(!p){
               ...
               p.innerHTML = `Anlaşması olmayan sağlık kurumlarında  3 SUT’a kadar ödeme avantajı!`;
